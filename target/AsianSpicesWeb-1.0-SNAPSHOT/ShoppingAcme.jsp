      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
                <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="mainpage.html">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="mainpage.html">About</a>
            </li>
              <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="mainpage.html">Mission</a>
            </li>
            <li class="nav-item">
...
<!--            <li class="nav-item">
 ...
 <form class="form-inline my-2 my-lg-0">
  ...
  <a href="paymentsPage.html" class="btn btn-success">Buy Now</a>
